...
const userNOSQL_1 = __importStar(require("../models/userNOSQL"));
class PermissionMiddleware {
     ...
     */
    checkIsTrabajador(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield userNOSQL_1.default.get(req.user, '', {
                    AttributesToGet: ['role'],
                });
                if (user.attrs.role === userNOSQL_1.UserRoles.TRABAJADOR) {
                    next();
                }
                else {
     ...
     */
    checkIsCreador(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield userNOSQL_1.default.get(req.user, '', {
                    AttributesToGet: ['role'],
                });
                if (user.attrs.role === userNOSQL_1.UserRoles.CREADOR) {
                    next();
                }
                else {
